...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView liberLogoSc;

  @NonNull
  public final TextView liberTextSc;

  private ActivitySplashScreenBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView liberLogoSc, @NonNull TextView liberTextSc) {
    this.rootView = rootView;
    this.liberLogoSc = liberLogoSc;
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.liber_logo_sc;
      ImageView liberLogoSc = ViewBindings.findChildViewById(rootView, id);
      if (liberLogoSc == null) {
        break missingId;
      }
      ...
      return new ActivitySplashScreenBinding((ConstraintLayout) rootView, liberLogoSc, liberTextSc);
    }
